          ...
          {_.map(coins, (coin) => (
            <Table.Row key={coin.coinName}>
              ...
              <Table.Cell p={1} bg={'bg.transparent'} h={'full'}>
                <Table.Cell color={'green.500'} border={'none'} textAlign={"center"} w={'3rem'} p={0} pr={2}>{coin.shares.accepted}</Table.Cell>
                <Table.Cell color={'red.500'} border={'none'} textAlign={"center"} w={'3rem'} p={0} pl={2}>{coin.shares.rejected}</Table.Cell>
              </Table.Cell >
